                  ...
                  <tbody>
                    ...
                    <tr class="{{$order->id}}">
                      ...
                      <td>
                        ...
                        <a title="Refund" href="{{route('orders.refund',$order->order_no)}}" class="btn btn-success btn-sm"><i class="fa fa-exchange-alt"></i></a>
                        @endif
                        <a href="{{route('orders.details',$order->order_no)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> </a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
