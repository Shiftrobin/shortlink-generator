                ...
                <form method="post" action="{{(@$editData)?route('products.update',$editData->id):route('products.store')}}" id="myForm" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      <label>Category <span style="color:red;font-weight: bold;">*</span></label>
                    ...
                    <div class="form-group col-md-4">
                      <label>Sub-Category <span style="color:red;font-weight: bold;">*</span></label>
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="old_collective_price" value="{{@$editData->old_collective_price}}" class="form-control form-control-sm">
                      <font color="red">{{($errors->has('old_collective_price'))?($errors->first('old_collective_price')):''}}</font>
                    </div>
                    <div class="form-group col-md-2">
                      <label>Current Coll Price <span style="color:red;font-weight: bold;">*</span></label>
                      <input type="text" name="current_collective_price" value="{{@$editData->current_collective_price}}" class="form-control form-control-sm">
                      <font color="red">{{($errors->has('current_collective_price'))?($errors->first('current_collective_price')):''}}</font>
                    </div>
                    <div class="form-group col-md-2">
                      <label>Old Del Price</label>
                      <input type="text" name="old_delivery_price" value="{{@$editData->old_delivery_price}}" class="form-control form-control-sm">
                      <font color="red">{{($errors->has('old_delivery_price'))?($errors->first('old_delivery_price')):''}}</font>
                    </div>
                    <div class="form-group col-md-2">
                      <label>Current Del Price <span style="color:red;font-weight: bold;">*</span></label>
                      <input type="text" name="current_delivery_price" value="{{@$editData->current_delivery_price}}" class="form-control form-control-sm">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="product_code" value="{{@$editData->product_code}}" class="form-control form-control-sm">
                    ...
                    <div class="form-group col-md-5">
                      ...
                      <div class="form-check form-check-inline">
                        <input type="checkbox" name="product_status[]" value="New Arrival" class="form-check-input product_status" {{in_array('New Arrival', explode(',', $all_status))?("checked"):""}}>
                      ...
                      <div class="form-check form-check-inline">
                        <input type="checkbox" name="product_status[]" value="Best Seller" class="form-check-input product_status" {{in_array('Best Seller', explode(',', $all_status))?("checked"):""}}>
                        <label class="form-check-label">Best Seller</label>
                      </div>
                    </div>
                    <div class="form-group col-md-5">
                      <label>Product Brands</label>
                      <select name="brand_id[]" class="form-control select2 form-control-sm" multiple>
                    ...
                    <div class="form-group col-md-2">
                      <label>VAT</label>
                      <select name="vat" class="form-control form-control-sm select2">
                        <option value="0" {{(@$editData->vat=="0")?"selected":""}}>0 %</option>
                        <option value="20" {{(@$editData->vat=="20")?"selected":""}}>20 %</option>
                      </select>
                      <font color="red">{{($errors->has('vat'))?($errors->first('vat')):''}}</font>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Product Image <span style="color: red;font-size: 12px;">(Size:640px X 640px)</span></label>
                      <input type="file" name="image" id="image" class="form-control form-control-sm">
                    </div>
                    <div class="form-group col-md-2">
                      <label>Stock Status</label>
                      <select name="stock_status" class="form-control form-control-sm select2">
                        <option value="In Stock" {{(@$editData->stock_status=="In Stock")?"selected":""}}>In Stock</option>
                        <option value="Out of Stock" {{(@$editData->stock_status=="Out of Stock")?"selected":""}}>Out of Stock</option>
                      </select>
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-3">
                      <label>Gallery Image <span style="color: red;font-size: 12px;">(Size:640px X 640px)</span></label>
                      <input type="file" name="gallery_image[]" class="form-control form-control-sm" multiple>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Product Tags </label>
                      <input type="text" name="product_tag" value="{{@$editData->product_tag}}" class="form-control form-control-sm" placeholder="Write Product Tags">
                    </div>
                    <div class="form-group col-md-6">
