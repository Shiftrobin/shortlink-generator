                ...
                <li class="nav-link">
                    {{-- <span class="image">
                        <img style="width: 35px; height:35px;"
                            src="{{ !empty(Auth::user()->image) ? url('public/upload/user_images/' . Auth::user()->image) : url('public/upload/no_image.png') }}"
                            class="img-circle elevation-2" alt="User Image">
                    </span> --}}
                    &nbsp;&nbsp;
                    <span class="text text-success">{{ Auth::user()->username }}</span>
                    &nbsp;&nbsp;
                    <span>
