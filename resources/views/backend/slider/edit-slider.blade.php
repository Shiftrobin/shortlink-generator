        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="{{route('site-setting.slider.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" name="button_text" value="{{@$editData->button_text}}" class="form-control">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Link</label>
                    ...
                    <div class="form-group col-md-2" style="padding-top:30px">
                      <img id="showImage" src="{{(!empty($editData->image))?url('public/upload/slider_images/'.$editData->image):url('public/upload/no_image.png')}}" style="width: 150px;border:1px solid #000;">
                    </div>
