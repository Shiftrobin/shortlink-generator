        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="{{route('site-setting.logo.store')}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      <label for="image">Image <span style="color: red;">(Size:107px X 70px)</span></label>
