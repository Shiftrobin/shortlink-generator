    ...
    <div class="ps-breadcrumb">
        <div class="container">
            <ul class="ps-breadcrumb__list">
                ...
                <li><a href="javascript:void(0);">You searched for : {{$search_for}}</a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    <div class="result__header">
                        <h4 class="title">You searched for : {{$search_for}}</span></h4>
                    </div>
                        ...
                        <div class="section-shop--grid">
                            <div class="row m-0">
                                ...
                                <div class="col-6 col-md-4 col-lg-3 p-0">
                                    <div class="ps-product--standard" style="border: 1px dotted;min-height: 340px !important"><a href="{{route('products.details.info',$product->slug)}}"><img class="ps-product__thumbnail" src="{{asset('public/upload/product_images/'.$product->image)}}" alt="alt" /></a>
