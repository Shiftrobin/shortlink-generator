    ...
    <div class="ps-breadcrumb">
        <div class="container">
            <ul class="ps-breadcrumb__list">
                ...
                <li><a href="javascript:void(0);">All Category</a></li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-12 col-lg-9">
                    <div class="category__top">
                        <div class="category__header">
                            <h3 class="category__name">All Category</h3>
                        </div>
                        <div class="shop__block category__carousel">
                            <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="5" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="5" data-owl-item-xl="5" data-owl-duration="1000" data-owl-mousedrag="on">
                                ...
                                @php
                                    $count_sub_product = App\Model\Product::where('sub_category_id',$sub_cat->sub_category_id)->count();
                                @endphp
                                <div class="categogy-item">
                                    <a href="{{route('sub.category.wise.product',$sub_cat->sub_category_id)}}">
                                        <img src="{{url('public/upload/sub_category_images/'.@$sub_cat['sub_category']['image'])}}" alt>
                                        <div class="categogy-name">{{@$sub_cat['sub_category']['name']}}</div>
                                        <div class="categogy-number">{{$count_sub_product}} items</div>
                                    </a>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="result__header">
                        <h4 class="title">Product List</span></h4>
                    </div>
