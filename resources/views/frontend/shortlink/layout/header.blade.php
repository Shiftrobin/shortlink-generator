...
<head>
    ...
    <!-- Data Tables -->
    <link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-2.2.1/sp-2.3.3/datatables.min.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="{{ asset('public/frontend') }}/images/favicon.png">
    <title>Short Link Generator Application | AIMS Education</title>
</head>
<body>
